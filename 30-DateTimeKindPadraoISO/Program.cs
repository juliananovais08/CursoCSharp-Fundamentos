...
namespace _30_DateTimeKindPadraoISO
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Atenção nessa parte!!!
            Console.WriteLine(d5.ToString("yyyy-MM-ddTHH:mm:ssZ")); // cuidado! deve primeiro garantir o formato universal pra depois fazer o toString()
            //Melhor exemplo abaixo:
